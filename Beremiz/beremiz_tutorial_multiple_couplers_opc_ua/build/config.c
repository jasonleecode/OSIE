...
__DECLARE_GLOBAL_LOCATION(DINT,__QD0_2)
__DECLARE_GLOBAL_LOCATED(DINT,CONFIG,RELAY6)
__DECLARE_GLOBAL_LOCATION(DINT,__QD0_3)
...
void config_init__(void) {
  ...
  __INIT_GLOBAL_LOCATED(CONFIG,RELAY4,__QD0_0,retain)
  __INIT_GLOBAL(DINT,RELAY4,__INITIAL_VALUE(0),retain)
  __INIT_GLOBAL_LOCATED(CONFIG,RELAY5,__QD0_1,retain)
  __INIT_GLOBAL(DINT,RELAY5,__INITIAL_VALUE(0),retain)
  __INIT_GLOBAL_LOCATED(CONFIG,RELAY6,__QD0_2,retain)
  __INIT_GLOBAL(DINT,RELAY6,__INITIAL_VALUE(0),retain)
  __INIT_GLOBAL_LOCATED(CONFIG,RELAY7,__QD0_3,retain)
