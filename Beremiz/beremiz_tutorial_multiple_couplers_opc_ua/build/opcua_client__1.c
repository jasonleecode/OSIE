...
int __init_1(int argc,char **argv)
{
    ...
    INIT_READ_VARIANT(UA_Int32, __ID1_4)
    INIT_READ_VARIANT(UA_Int32, __ID1_5)
    INIT_READ_VARIANT(UA_Int32, __ID1_6)
    INIT_READ_VARIANT(UA_Int32, __ID1_7)
    ...
    INIT_WRITE_VARIANT(UA_Int32, UA_TYPES_INT32, __QD1_4)
    INIT_WRITE_VARIANT(UA_Int32, UA_TYPES_INT32, __QD1_5)
    INIT_WRITE_VARIANT(UA_Int32, UA_TYPES_INT32, __QD1_6)
    INIT_WRITE_VARIANT(UA_Int32, UA_TYPES_INT32, __QD1_7)

    /* Connect to server */
    retval = UA_Client_connect(client, "opc.tcp://192.168.0.70:4840");
...
void __publish_1(void)
{
    ...
    WRITE_VALUE(UA_Int32, __QD1_4, UA_NODEID_STRING, 1, "i2c1.relay0")
    WRITE_VALUE(UA_Int32, __QD1_5, UA_NODEID_STRING, 1, "i2c1.relay1")
    WRITE_VALUE(UA_Int32, __QD1_6, UA_NODEID_STRING, 1, "i2c1.relay2")
    WRITE_VALUE(UA_Int32, __QD1_7, UA_NODEID_STRING, 1, "i2c1.relay3")
}
