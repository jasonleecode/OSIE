...
void COUNTERST_init__(COUNTERST *data__, BOOL retain) {
  ...
  __INIT_EXTERNAL(DINT,RELAY4,data__->RELAY4,retain)
  __INIT_EXTERNAL(DINT,RELAY5,data__->RELAY5,retain)
  __INIT_EXTERNAL(DINT,RELAY6,data__->RELAY6,retain)
  __INIT_EXTERNAL(DINT,RELAY7,data__->RELAY7,retain)
}
...
void COUNTERST_body__(COUNTERST *data__) {
  ...
  if (__GET_VAR(data__->RESET,)) {
    ...
    if ((__GET_VAR(data__->CNT1,) == 50)) {
      ...
      __SET_EXTERNAL(data__->,RELAY4,,1);
      __SET_EXTERNAL(data__->,RELAY5,,1);
      __SET_EXTERNAL(data__->,RELAY6,,1);
      __SET_EXTERNAL(data__->,RELAY7,,1);
    };
    if ((__GET_VAR(data__->CNT1,) == 100)) {
      ...
      __SET_EXTERNAL(data__->,RELAY4,,0);
      __SET_EXTERNAL(data__->,RELAY5,,0);
      __SET_EXTERNAL(data__->,RELAY6,,0);
      __SET_EXTERNAL(data__->,RELAY7,,0);
